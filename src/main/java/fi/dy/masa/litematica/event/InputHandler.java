...
public class InputHandler implements IKeybindProvider, IKeyboardInputHandler, IMouseInputHandler
{
    ...
    public boolean onKeyInput(int keyCode, int scanCode, int modifiers, boolean eventKeyState)
    {
        if (eventKeyState)
        {
            ...
            {
                return this.handlekeyUse(mc);
            }
            else if (mc.options.keyAttack.matchesKey(keyCode, scanCode))
            {
                return this.handlekeyAttack(mc);
            }
    ...
    private boolean handlekeyAttack(MinecraftClient mc)
    {
    ...
    private boolean handlekeyUse(MinecraftClient mc)
    {
        if (mc.player != null)
        {
